...
(D, dependenciesCount ,ET, initialAllowed, nTasks,  eta, initializationPheromone, Dp, mean_time) = initializeDependancyAndExecutionTimeMatrizes("./src/data/tasks.json", range(1, 10))